...
export namespace AdminTabs {
  export const add = [
    ...
    { name: 'Add category', value: AdminTabTitles.Add.ADD_CATEGORY, id: 4},
    { name: 'Add Image to Product', value: AdminTabTitles.Add.ADD_IMAGE, id: 5 },
    { name: 'Add product variation', value: AdminTabTitles.Add.ADD_PRODUCT_VARIATION, id: 6 },
    { name: 'Add variations details', value: AdminTabTitles.Add.ADD_VARIATION_DETAILS, id: 7 },
  ];
  ...
  export const change = [
    ...
    { name: 'Update variation details', value: AdminTabTitles.Change.CHANGE_VARIATION_DETAILS, id: 3 },
  ];
